...
class TaskSecondLogic extends GetxController {
  ...
  aboutTaskPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutTaskUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can provide you with tasks and notes"""),
      ],
      context: context,
    );
  }
